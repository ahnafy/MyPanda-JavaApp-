...
public class HorizontalScrollViewWrapper extends ViewWrapper<HorizontalScrollView> {
    ...
    public static class MyHScrollView extends HorizontalScrollView {
        ...
        protected void onScrollChanged(int l, int t, int oldl, int oldt) {
            ...
            if (this.ba != null) {
                this.ba.raiseEventFromUI(this, this.eventName + "_scrollchanged", Integer.valueOf(l));
            }
        }
    }
    ...
    public void innerInitialize(BA ba, String EventName, boolean keepOldObject) {
        ...
        if (ba.subExists(new StringBuilder(String.valueOf(EventName)).append("_scrollchanged").toString()) && (getObject() instanceof MyHScrollView)) {
